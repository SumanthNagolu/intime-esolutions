-- Interview Simulator Templates (FIXED for actual schema)
-- Schema-aligned: uses persona, focus_area, and rubric JSONB
...
INSERT INTO interview_templates (
  ...
  jsonb_build_object(
    'scenario_prompt', 'You are interviewing for a Junior Guidewire ClaimCenter Developer role. The interviewer will ask you about the ClaimCenter data model, including claims, exposures, incidents, and their relationships. Focus on demonstrating your understanding of:
...
INSERT INTO interview_templates (
  ...
  jsonb_build_object(
    'scenario_prompt', 'You are interviewing for a Mid-Level Guidewire PolicyCenter Developer. The interviewer will discuss:
- Product model configuration
- Rating and underwriting rules
- Job wizards and workflow customization
- Integration patterns with external systems

Demonstrate your hands-on experience. Use specific examples from projects you have worked on (or training scenarios). Explain trade-offs between configuration vs. code customization.',
    'evaluation_criteria', jsonb_build_object(
...
INSERT INTO interview_templates (
  ...
  jsonb_build_object(
    'scenario_prompt', 'You are interviewing for a Senior Guidewire BillingCenter Architect role. The interviewer will explore:
...
INSERT INTO interview_templates (
  ...
  'Guidewire Cloud',
  jsonb_build_object(
    'scenario_prompt', 'You are interviewing for a Guidewire Cloud Developer role. The discussion will cover:
...
INSERT INTO interview_templates (
  ...
  'Behavioral',
  jsonb_build_object(
    'scenario_prompt', 'This is a behavioral interview focused on your Guidewire project experience. The interviewer will ask about:
- Challenging technical problems you have solved
- How you have worked with business analysts and QA teams
- Times when you have had to learn something new quickly
- Situations where you have improved code quality or performance
- How you have handled tight deadlines or changing requirements
...
SELECT 
  ...
  p.code as product,
  t.persona as level,
  (t.rubric->>'estimated_duration_minutes')::int as duration_mins,
  t.focus_area,
  t.is_active
